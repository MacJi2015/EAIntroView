...
//  EAIntroView
//
//  Created by 郭嘉 on 2018/7/4.
//  Copyright © 2018年 郭嘉. All rights reserved.
//
...
@interface ViewController ()<EAIntroDelegate,UITableViewDelegate,UITableViewDataSource>{
    UIView *rootView;
    EAIntroView *_intro;
...
- (void)viewDidLoad {
    ...
    titleArr = @[@"showIntroWithCrossDissolve",@"showIntroWithFixedTitleView",@"showIntroWithCustomPages",@"showIntroWithCustomView",@"showIntroWithCustomViewFromNib",@"showIntroWithSeparatePagesInitAndPageCallback",@"showCustomIntro"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    static NSString *iditifier = @"cell";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:iditifier];
    if(cell == nil){
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:iditifier];
    }
